...
rem x64 version
cl -DWINDOW -D_WIN64 -D_MSC_VER -c -nologo -Os -O2 -Gm- -GR- -EHa -Oi -GS- -w payload.c /link /order:@extrabytes_x64.txt /entry:WndProc /fixed /nologo /subsystem:console /nodefaultlib /stack:0x100000,0x100000
